...
internal class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        AddRecipe(new ItemStack(Item.Stick, 3), ["#", '#', Block.Fence]);
        ...
        AddRecipe(new ItemStack(Item.Snowball, 4), ["#", '#', Block.SnowBlock]);
        AddRecipe(new ItemStack(Block.Clay, 1), ["##", "##", '#', Item.Clay]);
        AddRecipe(new ItemStack(Item.Clay, 4), ["#", '#', Block.Clay]);
        ...
        AddRecipe(new ItemStack(Block.Cobblestone), ["##", '#', new ItemStack(Block.Slab, 1, 3)]);
        AddRecipe(new ItemStack(Block.Stone), ["##", '#', new ItemStack(Block.Slab, 1, 0)]);
        AddRecipe(new ItemStack(Block.Sandstone), ["##", '#', new ItemStack(Block.Slab, 1, 1)]);
        AddRecipe(new ItemStack(Block.Sand, 2), ["#", '#', new ItemStack(Block.Slab, 1, 1)]);
        AddRecipe(new ItemStack(Block.Planks), ["##", '#', new ItemStack(Block.Slab, 1, 2)]);
        AddRecipe(new ItemStack(Item.Stick, 2), ["#", "#", '#', new ItemStack(Block.Slab, 1, 2)]);
        AddRecipe(new ItemStack(Block.Ladder, 2), ["# #", "###", "# #", '#', Item.Stick]);
        AddRecipe(new ItemStack(Item.Stick, 7), ["##", '#', Block.Ladder]);
        AddRecipe(new ItemStack(Item.WoodenDoor, 1), ["##", "##", "##", '#', Block.Planks]);
        AddRecipe(new ItemStack(Block.Planks, 6), ["#", '#', Item.WoodenDoor]);
        ...
        AddRecipe(new ItemStack(Item.Stick, 16), ["#", "#", '#', Block.Log]);
        AddRecipe(new ItemStack(Item.Stick, 4), ["#", "#", '#', Block.Planks]);
        AddRecipe(new ItemStack(Block.Planks, 2), "##", "##", '#', Item.Stick);
        ...
        AddRecipe(new ItemStack(Block.PoweredRail, 8), ["X X", "X#X", "XRX", 'X', Item.GoldIngot, 'R', Item.Redstone, '#', Item.Stick]);
        AddRecipe(new ItemStack(Block.DetectorRail, 8), ["X#X", "XSX", "XRX", 'X', Item.IronIngot, 'R', Item.Redstone, 'S', Item.Stick, '#', Block.StonePressurePlate]);
        AddRecipe(new ItemStack(Block.DetectorRail, 8), ["XRX", "XSX", "X#X", 'X', Item.IronIngot, 'R', Item.Redstone, 'S', Item.Stick, '#', Block.StonePressurePlate]);
        AddRecipe(new ItemStack(Item.Minecart, 1), ["# #", "###", '#', Item.IronIngot]);
        AddRecipe(new ItemStack(Item.IronIngot, 5), ["#", '#', Item.Minecart]);
        AddRecipe(new ItemStack(Block.JackLantern, 1), ["A", "B", 'A', Block.Pumpkin, 'B', Block.Torch]);
        AddRecipe(new ItemStack(Block.Pumpkin, 1), ["A", 'A', Block.JackLantern]);
        ...
        AddRecipe(new ItemStack(Block.Planks, 5), ["#", '#', Item.Boat]);
        ...
        AddRecipe(new ItemStack(Block.WoodenStairs, 6), ["#  ", "## ", "###", '#', Block.Planks]);
        AddRecipe(new ItemStack(Block.CobblestoneStairs, 6), ["#  ", "## ", "###", '#', Block.Cobblestone]);
        ...
        AddRecipe(new ItemStack(Block.Planks, 8), ["#", '#', Block.Chest]);
        AddRecipe(new ItemStack(Block.Cobblestone, 8), ["#", '#', Block.Furnace]);
        AddRecipe(new ItemStack(Block.Planks, 4), ["#", '#', Block.CraftingTable]);
        AddRecipe(new ItemStack(Block.Sand, 4), ["#", '#', Block.Sandstone]);
        AddRecipe(new ItemStack(Item.Flint, 1), ["#", '#', Block.Gravel]);
